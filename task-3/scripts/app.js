...
let app = {
    ...
    insertPawns() {
       ...
       whitePawnsRow = document.querySelectorAll('[data-rownum="7"]')
        ...
        blackPawnsRow = document.querySelectorAll('[data-rownum="2"]')
    ...
    getFigure(name, colorClass) {
        ...
        return `<i class="fas fa-chess-${name} ${colorClass} click"></i>`; // вставьте в ${} нужные значения
    },
